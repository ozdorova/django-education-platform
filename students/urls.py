...
urlpatterns = [
    ...
    path('course/<pk>/', cache_page(60 * 15)(views.StudentsCourseDetailView.as_view()),
         name='student_course_detail'),
    path('course/<pk>/<module_id>/', cache_page(60 * 15)(views.StudentsCourseDetailView.as_view()),
